...
public class mainlandchina extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mainlandchina);
    }
    int quantity=0;
    int quantity1=0;
    int quantity2=0;
    ...
    public void order (View view)
    {
        ...
        Intent i = new Intent(mainlandchina.this,ordersummary.class);
